...
def plot_line(data, ylbl, titl):
    ...
    legend_properties = {'weight':'bold','size':36}#adding legend properties for a more visible legend
...
brazil = stats_f("API_19_DS2_en_csv_v2_5346672.csv",[3,35,40,45,50,55,60,64],"Brazil")
india=stats_f("API_19_DS2_en_csv_v2_5346672.csv",[3,35,40,45,50,55,60,64],"India")
